...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', 'venv', '.github',
                    'Dockerfile', 'docs/guides/includes']
...
# html_theme_options = {
    ...
    #'navbar_pagenav_name': "Jump to Section",
...
#
# html_title = u'F5 Container Integration'
...
# of the sidebar.
#
html_logo = 'docs/_static/f5_logo.jpg'
...
# the title page.
#
latex_logo = 'docs/_static/f5_logo.jpg'
