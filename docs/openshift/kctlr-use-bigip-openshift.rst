...
.. important:: You can modify the **HOST IP** of any cluster member using annotations. See `Modifying HOST IP addresses using annotations <kctlr-openshift-annotation.html>`_.
