...
The |octlr-long| can be use as a BIG-IP orchestration platform. Because OpenShift is a Kubernetes application platform, the F5 integration for OpenShift utilizes the same controller as the :ref:`k8s-home` (``k8s-bigip-ctlr``). 
