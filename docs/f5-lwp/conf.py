# -*- coding: utf-8 -*-
#
# F5 Container Service Integrator documentation build configuration file, created by
...
project = u'F5 Lightweight Proxy'
...
.. _Kubernetes Deployment: http://kubernetes.io/docs/user-guide/deployments/
...
exclude_patterns = ['includes', '_build', 'Thumbs.db', '.DS_Store', 'venv',
                    '.github', 'Dockerfile']

# A list of warning types to suppress arbitrary warning messages.
suppress_warnings = ['image.nonlocal_uri']

# figures, tables and code-blocks are automatically numbered if they have
# a caption. At same time, the numref role is enabled.
numfig = True

# A dictionary mapping 'figure', 'table' and 'code-block' to strings
# that are used for format of figure numbers. Default is to use
# 'Fig. %s' for 'figure', 'Table %s' for 'table' and 'Listing %s'
# for 'code-block'.

# numfig_format

#The scope of figure numbers, that is, the numfig feature numbers figures in
#  which scope. 0 means “whole document”. 1 means “in a section”. Sphinx
#  numbers like x.1, x.2, x.3... 2 means “in a subsection”. Sphinx numbers
#  like x.x.1, x.x.2, x.x.3..., and so on. Default is 1.
...
#
html_title = u'F5 Lightweight Proxy'

# A shorter title for the navigation bar.  Default is the same as html_title.
#
html_short_title = 'F5 LWP'
...
html_static_path = ['static/f5-lwp']
...
htmlhelp_basename = 'F5_Lightweight_Proxy_doc'
...
latex_documents = [
    (master_doc, 'F5_Lightweight_Proxy.tex',
     u'F5 Lightweight Proxy - Documentation',
     'F5 Networks', 'manual'),
]
...
man_pages = [
    (master_doc, 'F5_Lightweight_Proxy',
     u'F5 Lightweight Proxy - Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'F5_Lightweight_Proxy',
     u'F5 Lightweight Proxy - Documentation',
     author, 'F5_Lightweight_Proxy',
     'F5 Lightweight Proxy - A lightweight proxy for distributed applications',
     'manual'),
]
