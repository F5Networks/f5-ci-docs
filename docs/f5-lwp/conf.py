...
rst_epilog = """
.. |fp| replace:: FlowPoint
.. |fpp| replace:: FlowPoint Proxy
.. |fppc| replace:: FlowPoint Proxy Controller
.. |csi| replace:: Container Service Integrator
.. |fp_version| replace:: v0.1.1
"""
...
#
html_title = u'F5 FlowPoint Proxy'

# A shorter title for the navigation bar.  Default is the same as html_title.
#
html_short_title = 'FlowPoint'
...
htmlhelp_basename = 'F5_FlowPoint-Proxy_doc'
...
latex_documents = [
    (master_doc, 'F5_FlowPoint_Proxy.tex',
     u'F5 FlowPoint Proxy - Documentation',
     'F5 Networks', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'F5_FlowPoint_Proxy',
     u'F5 FlowPoint Proxy - Documentation',
     author, 'F5_FlowPoint_Proxy',
     'F5 FlowPoint - A lightweight proxy for distributed applications',
     'manual'),
]
