...
#. Define the |asp| :ref:`global <#tbd>` settings in a `ConfigMap`_.
    ...
    .. literalinclude:: /_static/f5-asp-k8s-example-configmap.yaml
        :linenos:
        :emphasize-lines: 7-18

    :download:`f5-asp-k8s-example-configmap.yaml </_static/f5-asp-k8s-example-configmap.yaml>`

#. Create a `Kubernetes Daemonset`_.

    .. literalinclude:: /_static/f5-asp-k8s-example-daemonset.yaml
        :linenos:
        :emphasize-lines: 4, 5, 10, 14-26, 28-33

    :download:`f5-asp-k8s-example-daemonset.yaml </_static/f5-asp-k8s-example-daemonset.yaml>`
...
#. Edit the `Static Pod`_ manifest on each `Kubernetes node`_ (for example, :file:`/etc/kubernetes/kube-proxy.yaml`).
    ...
    .. literalinclude:: /_static/f5-asp-k8s-example-pod-manifest.yaml
        :linenos:
        :emphasize-lines: 10,

    :download:`quickstart-kube-proxy.yaml </_static/f5-asp-k8s-example-pod-manifest.yaml>`
