...
#. Edit the Guestbook Service definition in :file:`guestbook-service.json` to use ``"type": "NodePort"``.
    ...
    .. literalinclude:: /_static/demo-k8s-guestbook-service.json
        :emphasize-lines: 20

    :download:`demo-k8s-guestbook-service.json </_static/demo-k8s-guestbook-service.json>`
...
#. :ref:`Create a virtual server <k8s-create-bigip-objects>` on your BIG-IP for the Guestbook.
    ...
    .. literalinclude:: /_static/demo-k8s-guestbook-f5_configmap.yaml
        :emphasize-lines: 22-23

    :download:`demo-k8s-guestbook-f5_configmap.yaml </_static/demo-k8s-guestbook-f5_configmap.yaml>`
