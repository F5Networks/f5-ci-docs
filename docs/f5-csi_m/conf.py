...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', 'venv', '.github',
                    'Dockerfile', 'includes/f5-csc_m/deprecated']
...
#
html_title = u'F5 Container Service Integrator for Mesos+Marathon'
...
# of the sidebar.
#
html_logo = 'static/f5-csi_m/f5_logo.jpg'
...
htmlhelp_basename = 'F5_Container-Service-Integrator-Mesos_doc'
...
latex_documents = [
    (master_doc, 'F5-Container-Service-Integrator-Mesos.tex',
     u'F5 Container Service Integrator for Mesos - Documentation',
     'F5 Networks', 'manual'),
]
...
# the title page.
#
latex_logo = 'static/f5-csc_m/f5_logo.jpg'
...
man_pages = [
    (master_doc, 'F5-Container-Service-Integrator-Mesos',
     u'F5 Container Service Integrator for Mesos - Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'F5-Container-Service-Integrator-Mesos',
     u'F5 Container Service Integrator for Mesos - Documentation',
     author, 'F5-Container-Service-Integrator-Mesos',
     'F5 Container Service Integrator for Mesos Marathon'),
]
