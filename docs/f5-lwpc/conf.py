# -*- coding: utf-8 -*-
#
# F5 Container Service Controller documentation build configuration file,
# created by
...
project = u'F5 Lightweight Proxy Controller'
...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', 'venv', '.github',
                    'Dockerfile', 'includes/f5-lwpc/deprecated']
...
#
html_title = u'F5 Lightweight Proxy Controller'

# A shorter title for the navigation bar.  Default is the same as html_title.
#
html_short_title = u'F5 LWP Controller'

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
#
html_logo = 'static/f5-lwpc/f5_logo.jpg'
...
html_static_path = ['static/f5-lwpc']
...
htmlhelp_basename = 'F5_Lightweight_Proxy_Controller_doc'
...
latex_documents = [
    (master_doc, 'F5_Lightweight_Proxy_Controller.tex',
     u'F5 Lightweight Proxy Controller - Documentation',
     'F5 Networks', 'manual'),
]
...
# the title page.
#
latex_logo = 'static/f5-lwpc/f5_logo.jpg'
...
man_pages = [
    (master_doc, 'F5_Lightweight_Proxy_Controller',
     u'F5 Lightweight Proxy Controller Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'F5_Lightweight_Proxy_Controller',
     u'F5 Lightweight Proxy Controller Documentation',
     author, 'F5_Container-Service-Controller-Marathon', 'manual'),
]
