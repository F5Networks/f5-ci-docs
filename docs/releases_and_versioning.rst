...
.. table:: BIG-IP Controller/Platform compatibility
   ...
   |                          +-----------------------+                                            +--------------------------------------------+                          |
   |                          | v1.7.x-v1.11.x        |                                            | v1.6.x, v1.7.x, v1.8.x, v1.9.x,            |                          | 
   |                          |                       |                                            | v1.12.3, v1.13.4                           |                          |
   +--------------------------+-----------------------+--------------------------------------------+--------------------------------------------+--------------------------+
   |                                                                                                                                                                       |
   +--------------------------+-----------------------+--------------------------------------------+--------------------------------------------+--------------------------+
   ...
   |                          +-----------------------+--------------------------------------------+--------------------------------------------+                          |
   |                          | v1.7x, v1.8.x, v1.9.x | OpenShift Origin                           | v3.7.x, v3.11.x, v4.1.x                    |                          |
   |                          |                       +--------------------------------------------+                                            |                          |
   |                          |                       | Red Hat OpenShift Container Platform       |                                            |                          |
   |                          +-----------------------+--------------------------------------------+--------------------------------------------+--------------------------+
   |                          | v1.10.x, v1.11.x      | OpenShift Origin                           | v3.7.x, v3.11.x, v4.1.x                    || v12.x, v13.x, v14.x     |
